...
export const metadata: Metadata = {
  ...
  description: 'Exclusive intro offers at Euforyc Studios Edgware. Try 3 reformer pilates classes for £60, 3 hot pilates classes for £45, or 3 barre classes for £69. First-time clients only. Book today.',
