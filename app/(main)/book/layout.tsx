...
export const metadata: Metadata = {
  ...
  description: 'Book your reformer pilates, hot pilates, barre, or private session at Euforyc Studios Edgware. First-time intro offers from £45. Small classes, max 6 women. Book online now.',
