...
549 packages audited (540 prod, 15 optional). 0 vulnerabilities (js-yaml fix already applied upstream).
...
## Fixes Applied
- None needed — js-yaml 4.1.1 → 4.2.0 fix (GHSA-h67p-54hq-rp68) was already applied upstream in a prior scan
